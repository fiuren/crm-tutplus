...
function output_table_columns_data( $columnName, $post_id ) {
    ...
    /** 
* Registra un Meta Box en nuestro Tipo de Publicación Personalizada de Contacto, llamado 'Detalles de Contacto' 
*/
...
function acf_fields() {
	if( function_exists('acf_add_local_field_group') ):
		...
		acf_add_local_field_group(array(
			'key' => 'group_61f24a97cf48a',
			'title' => 'Phone Number',
			'fields' => array(
				array(
					'key' => 'field_61f24aa1466a7',
					'label' => 'Phone Number',
					'name' => 'phone_number',
					'type' => 'number',
					'instructions' => '',
		...
		acf_add_local_field_group(array(
			'key' => 'group_61f24af6a2487',
			'title' => 'Photo',
			'fields' => array(
				array(
					'key' => 'field_61f24afb05b86',
					'label' => 'Photo',
					'name' => 'photo',
					'type' => 'image',
					'instructions' => '',
		...
		acf_add_local_field_group(array(
			'key' => 'group_61f24b1571fae',
			'title' => 'Type',
			'fields' => array(
				array(
					'key' => 'field_61f24b1cbedbb',
					'label' => 'Type',
					'name' => 'type',
					'type' => 'select',
					'instructions' => '',
		...
		acf_add_local_field_group(array(
			'key' => 'group_61f249cf7cab8',
			'title' => 'Contact Details',
			'fields' => array(
				array(
					'key' => 'field_61f249f791c50',
					'label' => 'Email Address',
					'name' => 'email_address',
					'type' => 'text',
					'instructions' => '',
